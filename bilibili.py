...
返回：
    ...
    if original:
        ...
        ori = ''
    url = 'http://www.bilibili.tv/list/%s-%d-%d-%d-%d-%d~%d-%d-%d%s.html'%(sortType,zone,page,int(begintime[0]),int(begintime[1]),int(begintime[2]),int(endtime[0]),int(endtime[1]),int(endtime[2]),ori)
